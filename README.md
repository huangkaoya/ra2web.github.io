...
又名：网页红警一键部署包/chronodivide asssets。网页红井（网页版“红警”/Chronodivide）预览版测试站点，帮助各类爱好者一键搭建自己的网页版“红警”站点.
...
本仓库是《王二火大》的下游演示用仓库，本身并未依赖任何开源项目，其自身也只是编译后产物，用于网站部署演示，不代表《王二火大》及《王二火大》的参考项目chronodivide是开源项目，这两个项目都为闭源项目。

本项目（RA2WEB / 网页红井 / 红色井界 / 王二火大）仅用于个人研究和爱好用途，不得将本项目作为商业用途直接或间接使用。
在任何部署、分发、展示或二次发布时，必须**显著保留**以下任一名称：`RA2WEB`、`网页红井`、`红色井界`、`王二火大`，不得删除、隐藏或替换为其他名称。
...
本项目部署无法联机，联机请访问 王二火大 官网 wangerhuoda.com
